...
public class EaseImageView extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            borderColor = array.getColor(R.styleable.EaseImageView_imgBorderColor, borderColor);
            borderWidth = array.getDimensionPixelOffset(R.styleable.EaseImageView_imgBorderWidth, borderWidth);
            pressAlpha = array.getInteger(R.styleable.EaseImageView_imgPressAlpha, pressAlpha);
            pressColor = array.getColor(R.styleable.EaseImageView_imgPressColor, pressColor);
            radius = array.getDimensionPixelOffset(R.styleable.EaseImageView_imgRadius, radius);
            shapeType = array.getInteger(R.styleable.EaseImageView_imgShapeType, shapeType);
            array.recycle();
        }
