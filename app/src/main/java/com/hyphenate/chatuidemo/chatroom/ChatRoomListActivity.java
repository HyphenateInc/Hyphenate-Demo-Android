    ...
    private void initRecyclerView() {
        ...
        adapter.setItemClickListener(new EaseListItemClickListener() {
            @Override public void onItemClick(View view, int position) {
                startActivity(
                        new Intent(ChatRoomListActivity.this, ChatActivity.class).putExtra(EaseConstant.EXTRA_CHAT_TYPE, EaseConstant.CHATTYPE_CHATROOM)
                                .putExtra(EaseConstant.EXTRA_USER_ID, chatRoomList.get(position).getId()));
            }
