package com.hyphenate.chatuidemo.user.model.parse;
...
public class ParseManager {
    ...
    public void asyncGetCurrentUserInfo(final EMValueCallBack<UserEntity> callback) {
        final String username = EMClient.getInstance().getCurrentUser();
        asyncGetUserInfo(username, new EMValueCallBack<UserEntity>() {
