 ...
 */
public abstract class AgoraGroupChangeListener implements GroupChangeListener {
     ...
     * Please refer to {@link io.agora.chat.ChatOptions.setAutoAcceptGroupInvitation(boolean value)}
     */
    ...
    @Override public void onSharedFileAdded(String groupId, MucSharedFile sharedFile) {
