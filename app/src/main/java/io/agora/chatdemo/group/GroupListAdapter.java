...
public class GroupListAdapter extends RecyclerView.Adapter {
    ...
    private List<Group> groupList; // the private groups info set
    private List<GroupInfo> publicGroupList; // the public groups info set
    ...
    GroupListAdapter(Context context, List<GroupInfo> groups, boolean isPublic) {
        this.context = context;
    ...
    @Override public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            if (isPublic) {
                ...
                GroupInfo group = publicGroupList.get(position);
