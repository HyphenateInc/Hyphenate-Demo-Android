...
public class MessageNotifier {
    ...
    public synchronized void onNewMsg(List<ChatMessage> messages) {
        EaseUI.EaseSettingsProvider settingsProvider = EaseUI.getInstance().getSettingsProvider();
     ...
     * @param isForeground
     */
    private void sendNotification(List<ChatMessage> messages, boolean isForeground){
     ...
     * @param message
     */
    private void sendNotification(ChatMessage message, boolean isForeground, boolean numIncrease) {
