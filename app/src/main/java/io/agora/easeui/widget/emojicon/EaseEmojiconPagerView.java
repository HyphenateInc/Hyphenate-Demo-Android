...
import io.agora.easeui.adapter.EmojiconGridAdapter;
import io.agora.easeui.adapter.EmojiconPagerAdapter;
import io.agora.easeui.model.EaseEmojicon;
import io.agora.easeui.model.EaseEmojicon.Type;
...
public class EaseEmojiconPagerView extends ViewPager {
    ...
    public List<View> getGroupGridViews(EaseEmojiconGroupEntity groupEntity){
        ...
        for(int i = 0; i < pageSize; i++){
            ...
            final EmojiconGridAdapter
                    gridAdapter = new EmojiconGridAdapter(context, 1, list, emojiType);
