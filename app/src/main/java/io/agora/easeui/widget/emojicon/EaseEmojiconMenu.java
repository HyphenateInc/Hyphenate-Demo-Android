...
import io.agora.easeui.model.EaseEmojiconGroupEntity;
import io.agora.easeui.widget.emojicon.EaseEmojiconPagerView.EaseEmojiconPagerViewListener;
import io.agora.easeui.widget.emojicon.EaseEmojiconScrollTabBar.EaseScrollTabBarItemClickListener;
...
public class EaseEmojiconMenu extends EaseEmojiconMenuBase {
	...
	private int emojiconColumns = defaultColumns;
	private int bigEmojiconColumns = defaultBigColumns;
	private final static int defaultBigColumns = 4;
	private final static int defaultColumns = 7;
    ...
    private List<EaseEmojiconGroupEntity>
